...
from .serializers import CaffeineItemSerializer, ComplexConsumedItemSerializer, ComplexUserSerializer, UserSerializer
...
from .serializers import UserSerializer, ConsumedItemSerializer
...
class ConsumedItemViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = ComplexConsumedItemSerializer
